...
export function extractSaveData(saveId: string): ExportedSave | null {
  ...
  return {
    ...
    lastRoomId: exportData.lastRoomId,
    lastRoomCode: exportData.lastRoomCode,
    memberCount: exportData.memberCount,
    members: exportData.members,
    maxPlayers: exportData.maxPlayers,
    turnDuration: exportData.turnDuration,
    currentTurnNumber: exportData.currentTurnNumber,
    archivedTurns: exportData.archivedTurns,
