...
function convertToImportSaveData(save: ExportedSave) {
  return {
    ...
    originalId: save.id,
    type: save.type,
    lastRoomId: save.lastRoomId,
    lastRoomCode: save.lastRoomCode,
    memberCount: save.memberCount,
    members: save.members,
    maxPlayers: save.maxPlayers,
    turnDuration: save.turnDuration,
    currentTurnNumber: save.currentTurnNumber,
    archivedTurns: save.archivedTurns,
